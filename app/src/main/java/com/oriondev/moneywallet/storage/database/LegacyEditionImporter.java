...
import com.oriondev.Viti.storage.database.legacy.LegacyDatabaseImporter;
import com.oriondev.Viti.storage.database.legacy.LegacyUserPreferences;
...
public class LegacyEditionImporter {
    ...
    public static final String DATABASE_NAME = "Viti";
